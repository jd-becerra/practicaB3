...
function Separator1() {
  return (
    <div className='container mx-auto inline-flex border-y-4 border-y-gray-200 py-8 my-16 overflow-hidden relative'>
      ...
      <div className='absolute right-0 h-full w-1/12 bg-gradient-to-l from-white to-transparent'></div>
    </div>
  )
}
...
function Separator2() {
  ...
  return (
    <div className='container mx-auto border-y-4 border-y-gray-200 py-8 my-16 h-fit'>
      <img
        id='sticky-banner'
...
function Separator3() {
  return (
    <div className='container mx-auto border-y-4 border-y-gray-200 py-8 my-16 overflow-hidden relative inline-flex'> 
